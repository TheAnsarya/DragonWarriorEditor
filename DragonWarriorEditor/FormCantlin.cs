...
namespace DragonWarriorEditor {
    public partial class FormCantlin : Form
    {
        ...
        public FormCantlin(string gamePath)
        {
            InitializeComponent();
        ...
        private void loadMap()
        {
            ...
            foreach (char ch in data)
            {
                try
                {
                    PictureBox currentPictureBox = (PictureBox)FormCantlin.ActiveForm.Controls.Find("pictureBox" + x, true)[0];
        ...
        private void saveMap()
        {
            ...
            bool result = classDWBackend.setCantlinData(newCantlinHexData);
            if (result)
            {
