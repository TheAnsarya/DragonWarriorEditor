...
{
    public partial class FormGarinhamsGraveB1 : Form
    {
        string path;

        public FormGarinhamsGraveB1(string gamePath)
        {
            InitializeComponent();
        ...
        private void loadMap()
        {
            ...
            string garinhamsGraveB1HexData = classDWBackend.getGarinhamsGraveB1Data();
            int x = 1;
            bool hasError = false;

            foreach (char ch in garinhamsGraveB1HexData)
            {
                try
                {
                    PictureBox currentPictureBox = (PictureBox)FormGarinhamsGraveB1.ActiveForm.Controls.Find("pictureBox" + x, true)[0];
        ...
        {
            ClassDWBackend classDWBackend = new ClassDWBackend(path);
            string newGarinhamsGraveB1HexData = "";
            for (int x = 1; x <= 400; x++)
            {
                try
                {
            ...
            bool result = classDWBackend.setGarinhamsGraveB1Data(newGarinhamsGraveB1HexData);
            if (result)
            {
