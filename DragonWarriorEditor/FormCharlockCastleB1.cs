...
namespace DragonWarriorEditor {
    public partial class FormCharlockCastleB1 : Form
    {
        ...
        public FormCharlockCastleB1(string gamePath)
        {
            InitializeComponent();
        ...
        private void loadMap() {
            ...
            foreach (char ch in data)
            {
                try
                {
                    PictureBox currentPictureBox = (PictureBox)FormCharlockCastleB1.ActiveForm.Controls.Find("pictureBox" + x, true)[0];
        ...
        private void saveMap()
        {
            ...
            bool result = classDWBackend.setCharlockCastleB1Data(newCharlockCastleB1HexData);
            if (result)
            {
