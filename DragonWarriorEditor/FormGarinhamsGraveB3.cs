...
namespace DragonWarriorEditor {
	public partial class FormGarinhamsGraveB3 : Form {
		string path;

		public FormGarinhamsGraveB3(string gamePath) {
			InitializeComponent();
		...
		private void loadMap() {
			...
			string data = dataHandler.GetMapData(Definition.Map.GarinhamsGraveB3);
