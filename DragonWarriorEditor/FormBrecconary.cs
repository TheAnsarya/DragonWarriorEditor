...
namespace DragonWarriorEditor {
	public partial class FormBrecconary : Form {
		...
		public FormBrecconary(string gamePath) {
			InitializeComponent();
		...
		private void saveMap() {
			...
			bool result = classDWBackend.setBrecconaryData(newBrecconaryHexData);
			if (result) {
