...
{
    public partial class FormGarinhamsGraveB4 : Form
    {
        string path;

        public FormGarinhamsGraveB4(string gamePath)
        {
            InitializeComponent();
        ...
        private void loadMap()
        {
            ...
            string garinhamsGraveB4HexData = classDWBackend.getGarinhamsGraveB4Data();
            int x = 1;
            bool hasError = false;

            foreach (char ch in garinhamsGraveB4HexData)
            {
                try
                {
        ...
        {
            DataHandler classDWBackend = new DataHandler(path);
            string newGarinhamsGraveB4HexData = "";
            for (int x = 1; x <= 100; x++)
            {
                try
                {
            ...
            bool result = classDWBackend.setGarinhamsGraveB4Data(newGarinhamsGraveB4HexData);
            if (result)
            {
