...
{
    public partial class FormRockMountainCaveB1 : Form
    {
       string path;

       public FormRockMountainCaveB1(string gamePath)
        {
            InitializeComponent();
       ...
       private void loadMap()
       {
           ...
           string rockMountainB1HexData = classDWBackend.getRockMountainB1Data();
           int x = 1;
           bool hasError = false;

           foreach (char ch in rockMountainB1HexData)
           {
               try
               {
                   PictureBox currentPictureBox = (PictureBox)FormRockMountainCaveB1.ActiveForm.Controls.Find("pictureBox" + x, true)[0];
       ...
       {
           ClassDWBackend classDWBackend = new ClassDWBackend(path);
           string newRockMountainB1HexData = "";
           for (int x = 1; x <= 196; x++)
           {
               try
               {
           ...
           bool result = classDWBackend.setRockMountainB1Data(newRockMountainB1HexData);
           if (result)
           {
