...
{
    public partial class FormGarinhamsGraveB2 : Form
    {
        string path;

        public FormGarinhamsGraveB2(string gamePath)
        {
            InitializeComponent();
        ...
        private void loadMap()
        {
            ...
            string garinhamsGraveB2HexData = classDWBackend.getGarinhamsGraveB2Data();
            int x = 1;
            bool hasError = false;

            foreach (char ch in garinhamsGraveB2HexData)
            {
                try
                {
                    PictureBox currentPictureBox = (PictureBox)FormGarinhamsGraveB4.ActiveForm.Controls.Find("pictureBox" + x, true)[0];
        ...
        private void saveMap()
        {
            ...
            bool result = classDWBackend.setGarinhamsGraveB2Data(newGarinhamsGraveB2HexData);
            if (result)
            {
