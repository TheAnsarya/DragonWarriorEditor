...
namespace DragonWarriorEditor {
	public partial class FormTantegelCastleThroneRoom : Form {
		string path;

		public FormTantegelCastleThroneRoom(string gamePath) {
			InitializeComponent();
		...
		private void saveMap() {
			...
			for (int x = 1; x <= 100; x++) {
				try {
					...
					if (currentImageTag == "0-Grass") {
						newTantegelCastleThroneRoomHexData += "0";
					} else if (currentImageTag == "1-Desert") {
						newTantegelCastleThroneRoomHexData += "1";
					} else if (currentImageTag == "2-Water") {
						newTantegelCastleThroneRoomHexData += "2";
					} else if (currentImageTag == "3-TreasureChest") {
						newTantegelCastleThroneRoomHexData += "3";
					} else if (currentImageTag == "4-SolidStoneWall2") {
						newTantegelCastleThroneRoomHexData += "4";
					} else if (currentImageTag == "5-StairsUp") {
						newTantegelCastleThroneRoomHexData += "5";
					} else if (currentImageTag == "6-RedBrickFloor") {
						newTantegelCastleThroneRoomHexData += "6";
					} else if (currentImageTag == "7-StairsDown") {
						newTantegelCastleThroneRoomHexData += "7";
					} else if (currentImageTag == "8-Forest") {
						newTantegelCastleThroneRoomHexData += "8";
					} else if (currentImageTag == "9-PoisonousSwamp") {
						newTantegelCastleThroneRoomHexData += "9";
					} else if (currentImageTag == "A-Barrier") {
						newTantegelCastleThroneRoomHexData += "A";
					} else if (currentImageTag == "B-LockedDoor") {
						newTantegelCastleThroneRoomHexData += "B";
					} else if (currentImageTag == "C-WeaponShopSign") {
						newTantegelCastleThroneRoomHexData += "C";
					} else if (currentImageTag == "D-InnSign") {
						newTantegelCastleThroneRoomHexData += "D";
					} else if (currentImageTag == "E-Bridge") {
						newTantegelCastleThroneRoomHexData += "E";
					} else if (currentImageTag == "F-Desk") {
						newTantegelCastleThroneRoomHexData += "F";
					}
				} catch (Exception ex) {
			...
			bool result = classDWBackend.setTantegelCastleThroneRoomData(newTantegelCastleThroneRoomHexData);
			if (result) {
