...
{
    public partial class FormCharlockCastleB7 : Form
    {
        string path;

        public FormCharlockCastleB7(string gamePath)
        {
            InitializeComponent();
        ...
        private void loadMap()
        {
            ...
            string charlockCastleB7DataHexData = classDWBackend.getCharlockCastleB7Data();

            int x = 1;
            bool hasError = false;

            foreach (char ch in charlockCastleB7DataHexData)
            {
                try
                {
        ...
        {
            ClassDWBackend classDWBackend = new ClassDWBackend(path);
            string newCharlockCastleB7DataHexDataHexData = "";
            for (int x = 1; x <= 900; x++)
            {
                try
                {
                    ...
                    {
                        newCharlockCastleB7DataHexDataHexData += "0";
                    }
                    else if (currentImageTag == "1-Desert")
                    {
                        newCharlockCastleB7DataHexDataHexData += "1";
                    }
                    else if (currentImageTag == "2-Water")
                    {
                        newCharlockCastleB7DataHexDataHexData += "2";
                    }
                    else if (currentImageTag == "3-TreasureChest")
                    {
                        newCharlockCastleB7DataHexDataHexData += "3";
                    }
                    else if (currentImageTag == "4-SolidStoneWall2")
                    {
                        newCharlockCastleB7DataHexDataHexData += "4";
                    }
                    else if (currentImageTag == "5-StairsUp")
                    {
                        newCharlockCastleB7DataHexDataHexData += "5";
                    }
                    else if (currentImageTag == "6-RedBrickFloor")
                    {
                        newCharlockCastleB7DataHexDataHexData += "6";
                    }
                    else if (currentImageTag == "7-StairsDown")
                    {
                        newCharlockCastleB7DataHexDataHexData += "7";
                    }
                    else if (currentImageTag == "8-Forest")
                    {
                        newCharlockCastleB7DataHexDataHexData += "8";
                    }
                    else if (currentImageTag == "9-PoisonousSwamp")
                    {
                        newCharlockCastleB7DataHexDataHexData += "9";
                    }
                    else if (currentImageTag == "A-Barrier")
                    {
                        newCharlockCastleB7DataHexDataHexData += "A";
                    }
                    else if (currentImageTag == "B-LockedDoor")
                    {
                        newCharlockCastleB7DataHexDataHexData += "B";
                    }
                    else if (currentImageTag == "C-WeaponShopSign")
                    {
                        newCharlockCastleB7DataHexDataHexData += "C";
                    }
                    else if (currentImageTag == "D-InnSign")
                    {
                        newCharlockCastleB7DataHexDataHexData += "D";
                    }
                    else if (currentImageTag == "E-Bridge")
                    {
                        newCharlockCastleB7DataHexDataHexData += "E";
                    }
                    else if (currentImageTag == "F-Desk")
                    {
                        newCharlockCastleB7DataHexDataHexData += "F";
                    }
                }
                catch (Exception ex)
                {
            ...
            bool result = classDWBackend.setCharlockCastleB7Data(newCharlockCastleB7DataHexDataHexData);
            if (result)
            {
